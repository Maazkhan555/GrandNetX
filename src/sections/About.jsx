          ...
          <div className="grid grid-cols-12 md:grid-rows-12 gap-5">
            <div className="md:col-span-7 col-span-12 row-span-5">
              <div className="bg-black-300 rounded-2xl p-7 w-full h-full">
                ...
                <div className="mt-5">
                  <h1 className="text-blue-50 md:text-5xl text-3xl">GRANDNETX</h1>
                  <p className="md:text-2xl mt-2">
                    GrandNetX is a full-service IT company delivering cutting-edge
                    solutions across web development, mobile apps, UI/UX design,
                    cloud infrastructure, cybersecurity, AI integration, and digital
                    marketing. We transform ideas into powerful digital products that
            ...
            <div className="md:col-span-6 col-span-12 row-span-4">
              <div className="bg-black-300 rounded-2xl p-7 w-full h-full">
                <div className="flex flex-col justify-between h-full">
                  <h1 className="gradient-title md:text-5xl text-3xl font-bold">INNOVATE!</h1>
                  <h1 className="gradient-title md:text-5xl text-3xl font-bold">BUILD FAST!</h1>
                  <h1 className="gradient-title md:text-5xl text-3xl font-bold">SCALE SMART!</h1>
                </div>
              </div>
            </div>
                ...
                <div className="bg-black-300 rounded-2xl p-7 w-full h-full group cursor-pointer">
                  <div className="flex justify-between items-center h-full">
                    ...
                    <div className="group-hover:translate-x-2 group-hover:-translate-y-2 transition-transform">
                      <img src="/images/arrowupright.svg" alt="arrow-up" className="md:scale-100 scale-50" />
                    </div>
                  </div>
                </div>
              </div>
